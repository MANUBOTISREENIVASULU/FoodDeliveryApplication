                                ...
                                <div className="my-2">
                                    <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                        <li className="nav-item" role="presentation">
                                            <button className="nav-link active px-5 py-1 rounded-pill" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Diet Plan</button>
                                        </li>
                                        <li className="nav-item" role="presentation">
                                            <button className="nav-link px-5 py-1 rounded-pill" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Activity Plan</button>
                                        </li>
                            ...
                            <div className="container">
                                <div className="row  align-items-center justify-content-center">
                                    <div className="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                        ...
                                        <ul>
                                            <li className="py-2"><span className="fs-5 text-dark fw-bold">Balanced Diet </span>Focus on consuming a balanced diet rich in nutrients. Include plenty of protein-rich foods such as lean meats, poultry, fish, eggs, dairy, legumes, and nuts. Incorporate healthy fats from sources like avocados, olive oil, nuts, and seeds. Also, prioritize complex carbohydrates from whole grains, fruits, and vegetables.</li>
                                            <li className="py-2"><span className="fs-5 text-dark fw-bold">Regular Meals and Snacks </span>Aim to eat regular meals and snacks throughout the day to provide your body with a steady source of energy and nutrients. Avoid skipping meals, as this can further contribute to weight loss.</li>
                                            <li className="py-2"><span className="fs-5 text-dark fw-bold">Caloric Intake </span>Increase your caloric intake gradually by adding nutrient-dense foods to your meals and snacks. Choose foods that are high in calories but also nutritious, avoiding empty-calorie options like sugary snacks and beverages.</li>
                                            <li className="py-2"><span className="fs-5 text-dark fw-bold">Strength Training and Exercise </span>Incorporate strength training exercises into your routine to build muscle mass and improve overall strength. Additionally, engaging in regular physical activity can stimulate your appetite and promote healthy weight gain.</li>
                                            <li className="py-2"><span className="fs-5 text-dark fw-bold">Hydration </span> Stay hydrated by drinking an adequate amount of water throughout the day. Dehydration can affect your appetite and energy levels, so aim to drink water regularly.</li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                        <h3 className="mt-4 mb-3 text-danger">Non-Vegetarian Food Table</h3>
                                        <div className="table-responsive">
                                            <table className="table table-bordered">
                                                <thead>
                                                    <tr>
                        ...
                        <div className="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabIndex="0">
                            ...
                            <div className="container">
                                <div className="row  align-items-center justify-content-center">
                                    ...
                                    <div className="col-xs-12 col-sm-12 col-md-10 col-lg-10 p-3">
                                        <div className="my-2">
                                            <h3 className="mt-4 mb-3">Activity Plans</h3>
                                            <div className="table-responsive">
                                                <table className="table table-bordered">
                                                    <thead>
                                                        <tr>
